...
import { datetimeProblems } from './sql/datetime';
import { funnelProblems } from './sql/funnel';
...
export const PROBLEMS: Problem[] = [...conditionalProblems, ...joinsProblems, ...cteProblems, ...windowProblems, ...datetimeProblems, ...funnelProblems, ...revenueProblems, ...refundsProblems, ...logicProblems, ...pythonProblems, ...productProblems, ...experimentProblems];
